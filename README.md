Este repositorio es una copia del original forkeado de > [soyHenry/FT-M1](https://github.com/soyHenry/FT-M1) el cual tiene visibilidad privada. Para ejecutar los test dentro de cada carpeta ```homework``` hacer:
